...
training_data_file = open("D:/Programming/pycharm unified/data/mnist_train_100.csv", 'r')
...
test_data_file = open("D:/Programming/pycharm unified/data/mnist_test_10.csv", 'r')
